...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $mysqli->bank_transfer_in($_POST['amount_transfer'], $_POST['customer_id']);
    $mysqli->bank_transfer_out($_POST['amount_transfer'], $in_id);
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" id="form1" action="" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="user_name" class="col-sm-3 col-form-label">Money Destination
                                            User ID:</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="user_name"
                                                   name="customer_id"
                                                   placeholder="Enter Destination User ID" autofocus required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="user_name" class="col-sm-3 col-form-label">Amount you wish to
                                            transfer:</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="user_name"
                                                   name="amount_transfer"
                                                   placeholder="Enter the amount you want to transfer" autofocus
                                                   required>
                                        </div>
                                    </div>
